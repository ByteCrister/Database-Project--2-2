...
exports.getPcView = (request, response) => {
    if (request.session.isLoggedIn || request.session.isAdminLoggedIn) {
        const product_id = request.params.product_id;

        const sql1 = `SELECT * FROM pc_information WHERE pc_information_No = ${product_id};`;
                ...
                dataBase.query(sql3, (err3, data3) => {
                    ...
                    dataBase.query(
                        ...
                        (err4, data4) => {
                            ...
                            response.render(
                                path.join(__dirname, "/../../../public/Pc/Ejs/Desktop-Ejs-Pc-View.ejs"),
                                {
                                    pcData: data1,
                                    questionData: data2,
                                    reviewData: data3,
